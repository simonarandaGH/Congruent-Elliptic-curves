...
This small C++ program calculates in a few seconds all congruent numbers below 4*10^6. It is nothing more than the Tunnell's T. criterion, applied in a broad way. It is trivial to extend it to 10^9, 10^12. As well as modifying it to print the A_[] vectors.
  Full code always on xrank.cpp
